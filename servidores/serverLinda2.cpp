...
int main(int argc, char* argv[]) {
	...
	cout << "Iniciando servidor Linda nº2 en el puerto " << SERVER_PORT << endl;
    ...
    cout << "Cerrando servidor Linda n2"<< endl;
				...
				if (strcmp(operation,"PN" )== 0){
					...
					switch (size) {
						...
						case 5:
							...
							break;           
						default:
							cerr << "Error: tamaño de tupla erroneo en server2" << endl;
							soc.Close(client_fd);
							exit(1);
					}
					message = "OK";
					...
					switch (size) {
						case 4:
							ML4.RDN_2(t,t2,r1,r2);
							break;
						case 5:
							ML5.RDN_2(t,t2,r1,r2);
							break;           
						default:
							cerr << "Error: tamaño de tupla erroneo en server2" << endl;
							soc.Close(client_fd);
