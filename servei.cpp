...
void servCliente(Socket& soc, int client_fd, MonitorLinda& ML) {
	...
	while(!out) {
		...
		if (0 == strcmp(buffer, MENS_FIN)) {
			...
			if (strcmp(operacion,"PN" )== 0){
			...
			else if (strcmp(operacion,"RDN" )== 0){
			...
			else if (strcmp(operacion,"RDN_2" )== 0){
				// La operacion es ReadNote_2
				tupla = strtok (NULL, ":");
				Tupla t2 (ssize);
				t2.from_string(tupla);
				cout << "info: second decoded tuple: " << tupla << endl;
				Tupla r1(ssize), r2 (ssize);
				// Ejecución de la operación del monitor
				ML.RDN_2(t,t2,r1,r2);
				message = r1.to_string() + ":" + r2.to_string() + ":";
				cout << "info: RDN_2 resolves with: " <<  message << endl;
			}

			else if (strcmp(operacion,"RN_2") == 0){
				...
				ML.RN_2(t,t2,r1,r2);
				message = r1.to_string() + ":" + r2.to_string() + ":";
				cout << "info: RN_2 resolves with: " <<  message << endl;
			}
